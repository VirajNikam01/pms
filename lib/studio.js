...
const DbInspector = () => {
  ...
  if (!authorized) {
    return (
      <motion.div
        ...
        initial="hidden"
        animate="visible"
        className="bg-gray-900 min-h-screen flex items-center justify-center p-4 pb-60"
      >
  ...
  if (!db || !db.schema) {
    return (
      <SecondaryButton className="bg-gray-900 min-h-screen flex items-center justify-center">
