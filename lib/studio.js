                    ...
                    {table.getHeaderGroups().map((headerGroup) => (
                      <tr key={headerGroup.id}>
                        {headerGroup.headers.map((header) => (
                          <th
                            key={header.id}
                            className="px-2 py-2 font-semibold text-gray-300 border-r last:border-r-0"
                    ...
                    {table.getRowModel().rows.map((row) => (
                      ...
                      >
                        {row.getVisibleCells().map((cell) => (
                          <td
                            key={cell.id}
                            className="px-2 py-2 whitespace-nowrap border-r last:border-r-0 relative"
                          >
                            {flexRender(
              ...
              <div className="flex items-center justify-between mt-4">
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="px-3 py-2 bg-gray-700 rounded-lg text-gray-200 disabled:opacity-50 text-xs"
                ...
                <select
                  ...
                  className="border border-gray-700 bg-gray-800 rounded-lg px-2 py-1 text-gray-200 text-xs"
